if (process.env.NODE_ENV !== 'production') {
  require('dotenv').config() //*load env variables in env file if in development mode
}
...
const indexRouter = require("./routes/index"); //router for index.js
const authorRouter = require("./routes/authors"); //router for author.js
...
app.use("/authors", authorRouter); //*every route in authors router will be prepended with "/authors"
